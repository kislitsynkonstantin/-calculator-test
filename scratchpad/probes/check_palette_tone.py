...
оформления, днём и ночью, на 390 и 1440 px:
  ...
  • хвойный, бордо, индиго, графит и титан (поворот тона со своей
...
def проверить(бр, порт, ш, в, бланк, ночь):
    ...
    if not строка:
        ...
        if строка["варианты"] != ["Бирюзовый", "Синий", "Хвойный", "Бордо", "Индиго", "Графит", "Титан"] \
    ...
    for тон in ("pine", "wine", "indigo", "graphite", "titan"):
