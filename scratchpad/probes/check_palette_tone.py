...
оформления, днём и ночью, на 390 и 1440 px:
  ...
  • хвойный, бордо, медь, индиго, графит и титан (поворот тона со своей
...
def проверить(бр, порт, ш, в, бланк, ночь):
    ...
    if not строка:
        ...
        if строка["варианты"] != ["Бирюзовый", "Синий", "Хвойный", "Бордо", "Медь", "Индиго", "Графит", "Титан"] \
    ...
    for тон in ("pine", "wine", "copper", "indigo", "graphite", "titan"):
