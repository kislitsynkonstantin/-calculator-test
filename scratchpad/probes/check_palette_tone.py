...
оформления, днём и ночью, на 390 и 1440 px:
  ...
  • графит и титан (не поворот тона — своя насыщенность): страница, логотип,
...
def проверить(бр, порт, ш, в, бланк, ночь):
    ...
    if not строка:
        ...
        if строка["варианты"] != ["Бирюзовый", "Синий", "Графит", "Титан"] or строка["выбран"] != "teal":
