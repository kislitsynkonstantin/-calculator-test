...
Проба держит на 390 и 1440, в обеих темах:
  ...
  • у «глаза» отдельный переключатель «Не скрывать опции со звёздочкой»: с
    ним невыбранная опция со звёздочкой видна, без него — скрыта; в подписи
    «Скрывать не выбранные» звёздочки больше нет.
...
СЦЕНАРИЙ = """async () => {
  ...
  // 3. настройки: старое сохранённое stars:true
