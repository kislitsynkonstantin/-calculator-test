...
«по размеру как компьютер». Значок виден всем: «я когда вижу пресет на
...
Проба держит:
  • в правом нижнем углу каждой своей карточки значок — и у менеджера, и у
    администратора: глобус — пресет в базе, экран — ждёт связи в очереди;
...
def главная():
    ...
    if НАХОДКИ:
        ...
        for н in НАХОДКИ[:40]:
            print("  ✗", н)
        raise SystemExit(1)
    print("Чисто: у менеджера и администратора в правом нижнем углу карточки глобус — пресет в базе — или экран — ждёт связи; "
