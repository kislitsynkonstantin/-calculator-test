...
и ночью, на 390 / 768 / 1440 px:
  ...
  • тоны-пары перечислены в ПАРЫ; новый проверяется всеми пунктами выше
    строкой в таблице.
...
# скидкой на нём. «Бирюза-антрацит» стоял здесь в (38), снят в (39).
ПАРЫ = {
...
def главная():
    ...
    if НАХОДКИ:
        ...
        for н in НАХОДКИ:
            print("  ✗", н)
        sys.exit(1)
    print("Чисто: в тонах-парах карточка и полоска итога — тёмный своей пары, "
